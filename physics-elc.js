...
let QuestionsData = [
    ...
    '内部抵抗<button class="tile">r</button>[Ω], 1目盛り<button class="tile">i</button>[A]の電流計X, 及び可変抵抗Yがある.<blockquote>(1)<br>抵抗Yを並列接続してXを1目盛り<span class="math"><button class="tile">I</button>( ＞i )</span>[A]の電流計として用いたい.<br>回路全体に<span class="math">I</span>[A]の電流を流すとき, Yには<button class="input-box"></button>[A]の電流が流れるとよい.<br>このときYに加わる電圧は<button class="input-box"></button>[V]となるから, Yの抵抗値は<frac><fn><button class="input-box"></button></fn><fd><button class="input-box"></button></fd></frac>[Ω]とすればよい.<br>数値計算は<button class="tile tfunc">(I＋i)</button>, <button class="tile tfunc">(I－i)</button>を用いよ</blockquote><blockquote>(2)<br>抵抗Yを直列接続してXを1目盛り<span class="math"><button class="tile">V</button></span>[V]の電圧計として用いたい.<br>回路全体に<span class="math">i</span>[A]の電流を流すとき, Xには<button class="input-box"></button>[V]の電圧が生じる.<br>このときYに加わる電圧は<span class="math"><button class="input-box"></button>－<button class="input-box"></button></span>[V]となるから, Yの抵抗値は<span class="math"><frac><fn><button class="input-box"></button></fn><fd><button class="input-box"></button></fd></frac>－<button class="input-box"></button></span>[Ω]とすればよい.</blockquote><div id="secret-answer">0:(I－i):1,Num:1;1:Num:1,i:1,r:1;2:Num:1,i:1,r:1;3:(I－i):1,Num:1;4:Num:1,i:1,r:1;5:Num:1,V:1;6:Num:1,i:1,r:1;7:Num:1,V:1;8:Num:1,i:1;9:Num:1,r:1</div>',
...
function showHelpme() {
    if (confirm("問題をスキップしたことになりますがよろしいですか？")) {
        let helpButton = document.getElementById('help-button');
