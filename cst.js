...
const questions = [
    ...
    ['sinAcosB＋cosAsinB ＝ ?', 'sin(A＋B)', 'cos(A＋B)', 'sin(A－B)', 'cos(A－B)', '1', 5],
    ['sinAcosB－cosAsinB ＝ ?', 'sin(A＋B)', 'cos(A＋B)', 'sin(A－B)', 'cos(A－B)', '2', 5],
    ['cosAcosB－sinAsinB ＝ ?', 'sin(A＋B)', 'cos(A＋B)', 'sin(A－B)', 'cos(A－B)', '3', 5],
    ['cosAcosB＋sinAsinB ＝ ?', 'sin(A＋B)', 'cos(A＋B)', 'sin(A－B)', 'cos(A－B)', '4', 5],
